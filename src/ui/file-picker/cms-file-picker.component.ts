...
@Component({
    ...
    `,
    styles: [`
        .fp { border: 1px solid var(--cms-border, #e5e7eb); border-radius: var(--cms-radius, 6px); overflow: hidden; }
        .fp__bar {
        ...
        .fp__crumb {
            ...
            color: var(--cms-accent-text, #7C4D00); border-radius: var(--cms-radius-sm, 4px);
        }
